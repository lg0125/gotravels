package com.chris.gotravels.frameworks.web;

import com.chris.gotravels.frameworks.convention.errorcode.BaseErrorCode;
import com.chris.gotravels.frameworks.convention.exception.AbstractException;
...
/*
* 返回对象构造器
*   配合convention组件的 Result全局返回对象使用，Results 提供 Result 的快捷构建
* */
