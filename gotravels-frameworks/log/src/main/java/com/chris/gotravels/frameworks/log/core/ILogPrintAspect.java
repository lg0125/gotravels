package com.chris.gotravels.frameworks.log.core;

import cn.hutool.core.date.DateUtil;
import cn.hutool.core.date.SystemClock;
import com.alibaba.fastjson2.JSON;
import com.chris.gotravels.frameworks.log.annotation.ILog;
import com.chris.gotravels.frameworks.log.annotation.ILogPrintDTO;
...
public class ILogPrintAspect {
     ...
     * 打印类或方法上的 {@link ILog}
     */
    @Around("@within(com.chris.gotravels.frameworks.log.annotation.ILog) || @annotation(com.chris.gotravels.frameworks.log.annotation.ILog)")
...
/*
* 定义日志注解AOP扫描类，执行方法执行前后增强，最终打印方法执行日志
* @within和@annotation注解分别对注解在类上和在方法上增强
* */