...
import com.chris.gotravels.ticketservice.common.constant.GotravelsConstant;
...
import static com.chris.gotravels.ticketservice.common.constant.RedisKeyConstant.TRAIN_INFO;
import static com.chris.gotravels.ticketservice.common.constant.RedisKeyConstant.TRAIN_STATION_STOPOVER_DETAIL;
...
public class TrainPurchaseTicketParamVerifyChainHandler implements TrainPurchaseTicketChainFilter<PurchaseTicketReqDTO> {
    ...
    public void handler(PurchaseTicketReqDTO requestParam) {
        ...
        List<TrainStationDO> trainDOList = JSON.parseArray(
                trainStationStopoverDetailStr,
                TrainStationDO.class
        );
