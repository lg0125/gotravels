package com.chris.gotravels.ticketservice.dao.mapper;
...
public interface SeatMapper extends BaseMapper<SeatDO> {
     ...
     * 获取列车车厢余票集合
     */
    List<Integer> listSeatRemainingTicket(
            @Param("seatDO") SeatDO seatDO,
     ...
     */
    List<SeatTypeCountDTO> listSeatTypeCount(
