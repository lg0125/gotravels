...
import com.chris.gotravels.ticketservice.dao.entity.CarriageDO;
import com.chris.gotravels.ticketservice.dao.mapper.CarriageMapper;
import com.chris.gotravels.ticketservice.service.CarriageService;
...
import static com.chris.gotravels.ticketservice.common.constant.RedisKeyConstant.LOCK_QUERY_CARRIAGE_NUMBER_LIST;
import static com.chris.gotravels.ticketservice.common.constant.RedisKeyConstant.TRAIN_CARRIAGE;
        ...
        return safeGetCarriageNumber(
                ...
                () -> {
                    ...
                    List<String> carriageListWithOnlyNumber = carriageDOList.stream()
                            .map(CarriageDO::getCarriageNumber)
                            .collect(Collectors.toList());

                    return StrUtil.join(
                            StrUtil.COMMA,
                            carriageListWithOnlyNumber
                    );
                }
        );
    }
