package com.chris.gotravels.payservice.service.payid;
...
public final class PayIdGeneratorManager implements InitializingBean {
    ...
    public static String generateId(String orderSn) {
        return DISTRIBUTED_ID_GENERATOR.generateId() +
                orderSn.substring(orderSn.length() - 6);
    }
    ...
    public void afterPropertiesSet() {
        ...
        try {
            ...
            // 注意：这里只是提供一种分库分表基因法的实现思路，所以将标识位定义 32
