...
import com.chris.gotravels.payservice.common.constant.PayRocketMQConstant;
...
public class PayResultCallbackOrderSendProduce
    ...
    public PayResultCallbackOrderSendProduce(
    ...
    protected Message<?> buildMessage(
            PayResultCallbackOrderEvent messageSendEvent,
