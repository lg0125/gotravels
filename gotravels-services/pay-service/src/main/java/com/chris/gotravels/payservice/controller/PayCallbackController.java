...
import com.chris.gotravels.payservice.convert.PayCallbackRequestConvert;
...
public class PayCallbackController {
    ...
    public void callbackAlipay(@RequestParam Map<String, Object> requestParam) {
        PayCallbackCommand payCallbackCommand = BeanUtil.mapToBean(
                requestParam,
                PayCallbackCommand.class,
                true,
                CopyOptions.create()
        );
