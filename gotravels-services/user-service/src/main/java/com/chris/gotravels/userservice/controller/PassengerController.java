...
public class PassengerController {
    ...
    public Result<List<PassengerRespDTO>> listPassengerQueryByUsername() {
        return Results.success(
                passengerService.listPassengerQueryByUsername(
    ...
    public Result<List<PassengerActualRespDTO>> listPassengerQueryByIds(
        ...
        return Results.success(
                passengerService.listPassengerQueryByIds(
                        username, ids
                )
        );
    }
    ...
    @Idempotent(
            ...
            key = "T(com.chris.gotravels.frameworks.biz.user.core.UserContext).getUsername()",
